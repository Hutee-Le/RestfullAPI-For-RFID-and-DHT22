...
const char *URL = "http://192.168.9.138:5555/DHT22/post"; 
// const char *URL = "http://10.106.24.215:3000/dht11"; 
...
void postJsonData() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    if (http.begin(client, URL)) {  // HTTP
      ...
      float t =("%.2f",dht.readTemperature()) ;
      
      
      doc["id"] = "11";
      doc["humid"] = h;
      doc["temperature"] = t;
      // doc["atTime"] = "2021-06-07 16:48:00";
